...
extension CfInsertNxCommand on CuckooFilterCommands {
  /// CF.INSERTNX key [CAPACITY capacity] `[NOCREATE]` ITEMS item [item ...]
  Future<List<bool>> cfInsertNx(
    String key,
    List<String> items, {
    int? capacity,
    bool noCreate = false,
    ...
    await checkValkeySupport('CF.INSERTNX', forceRun: forceRun);

    final cmd = <dynamic>['CF.INSERTNX', key];
