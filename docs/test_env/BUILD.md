...
```yaml
# version: 4.3.0  # Previous version
version: 4.3.1   # New version
```
...
Create a new release on GitHub. Use the tag you just created (e.g., `v4.3.1`). Copy the relevant section from `CHANGELOG.md` into the release notes.
