...
```yaml
# version: 4.3.2  # Previous version
version: 4.4.0   # New version
```
...
Create a new release on GitHub. Use the tag you just created (e.g., `v4.4.0`). Copy the relevant section from `CHANGELOG.md` into the release notes.
